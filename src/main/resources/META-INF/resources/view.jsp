...
<clay:container-fluid>
  <c:if test="<%= documentFolderId != 0 %>">
      <div class="alert alert-warning d-flex justify-content-between align-items-center mb-4">
          <div><strong>Aviso:</strong> Voc? precisa configurar uma pasta de documentos para cadastrar editais.</div>
  ...
  >
      ...
      >
          ...
          <liferay-ui:search-container-column-text name="Data in?cio">
