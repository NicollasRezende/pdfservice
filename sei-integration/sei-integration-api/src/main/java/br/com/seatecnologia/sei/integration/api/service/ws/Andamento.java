...
public class Andamento  implements java.io.Serializable {
    ...
    private br.com.seatecnologia.sei.integration.api.service.ws.AtributoAndamento[] atributos;
    ...
    public Andamento(
           ...
           br.com.seatecnologia.sei.integration.api.service.ws.AtributoAndamento[] atributos) {
     ...
     * @return atributos
     */
    public br.com.seatecnologia.sei.integration.api.service.ws.AtributoAndamento[] getAtributos() {
        return atributos;
    }
     ...
     * @param atributos
     */
    public void setAtributos(br.com.seatecnologia.sei.integration.api.service.ws.AtributoAndamento[] atributos) {
        this.atributos = atributos;
    }
