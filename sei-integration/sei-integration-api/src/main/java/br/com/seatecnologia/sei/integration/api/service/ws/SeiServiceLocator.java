...
public class SeiServiceLocator extends org.apache.axis.client.Service implements br.com.seatecnologia.sei.integration.api.service.ws.SeiService {
    ...
    private java.lang.String SeiPortService_address = "https://laboratorio-sei4.sei.df.gov.br/sei/ws/SeiWS.php";
    ...
    public br.com.seatecnologia.sei.integration.api.service.ws.SeiPortType getSeiPortService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.seatecnologia.sei.integration.api.service.ws.SeiBindingStub _stub = new br.com.seatecnologia.sei.integration.api.service.ws.SeiBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.com.seatecnologia.sei.integration.api.service.ws.SeiPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.seatecnologia.sei.integration.api.service.ws.SeiBindingStub _stub = new br.com.seatecnologia.sei.integration.api.service.ws.SeiBindingStub(new java.net.URL(SeiPortService_address), this);
                _stub.setPortName(getSeiPortServiceWSDDServiceName());
                return _stub;
            }
        }
