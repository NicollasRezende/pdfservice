...
/**
 * Provides the local service interface for ConcessaoDf. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ConcessaoDfLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ConcessaoDfLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>br.com.seatecnologia.gdf.negocia.service.impl.ConcessaoDfLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the concessao df local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ConcessaoDfLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ConcessaoDf addConcessaoDf(
	...
	public ConcessaoDf updateConcessaoDf(
			long concessaoId, long propostaId, double percentualDescontoJuros,
			double percentualDescontoPrincipal, String observacoes)
		throws PortalException;
