...
/**
 * Provides the local service interface for DemaisPartes. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DemaisPartesLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DemaisPartesLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>br.com.seatecnologia.gdf.negocia.service.impl.DemaisPartesLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the demais partes local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DemaisPartesLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public DemaisPartes addDemaisPartes(
