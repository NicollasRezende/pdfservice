...
/**
 * The persistence utility for the advogado service. This utility wraps <code>br.com.seatecnologia.gdf.negocia.service.persistence.impl.AdvogadoPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class AdvogadoUtil {
	 ...
	 */
	public static void clearCache(Advogado advogado) {
		getPersistence().clearCache(advogado);
	}
	 ...
	 */
	public static Map<Serializable, Advogado> fetchByPrimaryKeys(
	 ...
	 */
	public static List<Advogado> findWithDynamicQuery(
	 ...
	 */
	public static Advogado update(Advogado advogado) {
		return getPersistence().update(advogado);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static Advogado update(
		Advogado advogado, ServiceContext serviceContext) {

		return getPersistence().update(advogado, serviceContext);
	}
	 ...
	 */
	public static List<Advogado> findByUuid(String uuid) {
	 ...
	 */
	public static List<Advogado> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	public static List<Advogado> findByUuid(
	 ...
	 */
	public static Advogado fetchByUuid_First(
		String uuid, OrderByComparator<Advogado> orderByComparator) {
	 ...
	 * @throws NoSuchAdvogadoException if a matching advogado could not be found
	 */
	public static Advogado findByUuid_Last(
			String uuid, OrderByComparator<Advogado> orderByComparator)
		throws br.com.seatecnologia.gdf.negocia.exception.
			NoSuchAdvogadoException {
	 ...
	 */
	public static Advogado fetchByUuid_Last(
		String uuid, OrderByComparator<Advogado> orderByComparator) {
	 ...
	 */
	public static Advogado[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			advogadoId, uuid, orderByComparator);
	}
	 ...
	 */
	public static void cacheResult(Advogado advogado) {
		getPersistence().cacheResult(advogado);
	}
	 ...
	 */
	public static void cacheResult(List<Advogado> advogados) {
		getPersistence().cacheResult(advogados);
	}
	 ...
	 */
	public static Advogado create(long advogadoId) {
		return getPersistence().create(advogadoId);
	}
	 ...
	 * @throws NoSuchAdvogadoException if a advogado with the primary key could not be found
	 */
	public static Advogado remove(long advogadoId)
		throws br.com.seatecnologia.gdf.negocia.exception.
			NoSuchAdvogadoException {

		return getPersistence().remove(advogadoId);
	}

	public static Advogado updateImpl(Advogado advogado) {
		return getPersistence().updateImpl(advogado);
	}
	 ...
	 * @throws NoSuchAdvogadoException if a advogado with the primary key could not be found
	 */
	public static Advogado findByPrimaryKey(long advogadoId)
		throws br.com.seatecnologia.gdf.negocia.exception.
			NoSuchAdvogadoException {

		return getPersistence().findByPrimaryKey(advogadoId);
	}
	 ...
	 */
	public static Advogado fetchByPrimaryKey(long advogadoId) {
		return getPersistence().fetchByPrimaryKey(advogadoId);
	}
	 ...
	 */
	public static List<Advogado> findAll() {
	 ...
	 */
	public static List<Advogado> findAll(int start, int end) {
	...
	public static AdvogadoPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(AdvogadoPersistence persistence) {
		_persistence = persistence;
	}

	private static volatile AdvogadoPersistence _persistence;
