...
/**
 * Provides the local service interface for FundamentacaoPedido. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FundamentacaoPedidoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FundamentacaoPedidoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>br.com.seatecnologia.gdf.negocia.service.impl.FundamentacaoPedidoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the fundamentacao pedido local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FundamentacaoPedidoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public FundamentacaoPedido addFundamentacaoPedido(
		ServiceContext serviceContext, String fundamentacaoPedido,
		long propostaId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FundamentacaoPedido> getFundamentacoesPedidoByPropostaId(
		long propostaId);
