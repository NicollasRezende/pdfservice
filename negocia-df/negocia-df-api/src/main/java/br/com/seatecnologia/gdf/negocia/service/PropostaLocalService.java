...
public interface PropostaLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>br.com.seatecnologia.gdf.negocia.service.impl.PropostaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the proposta local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PropostaLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Proposta createPropostaCompleteZip(
