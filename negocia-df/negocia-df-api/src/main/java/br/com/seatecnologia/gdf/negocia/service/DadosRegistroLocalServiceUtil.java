...
/**
 * Provides the local service utility for DadosRegistro. This utility wraps
 * <code>br.com.seatecnologia.gdf.negocia.service.impl.DadosRegistroLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DadosRegistroLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>br.com.seatecnologia.gdf.negocia.service.impl.DadosRegistroLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static DadosRegistro addDadosRegistro(DadosRegistro dadosRegistro) {
		return getService().addDadosRegistro(dadosRegistro);
	}
	 ...
	 */
	public static DadosRegistro createDadosRegistro(long dadosRegistroId) {
		return getService().createDadosRegistro(dadosRegistroId);
	}
	 ...
	 */
	public static DadosRegistro deleteDadosRegistro(
		DadosRegistro dadosRegistro) {

		return getService().deleteDadosRegistro(dadosRegistro);
	}
	 ...
	 */
	public static DadosRegistro deleteDadosRegistro(long dadosRegistroId)
		throws PortalException {

		return getService().deleteDadosRegistro(dadosRegistroId);
	}
	...
	public static DadosRegistro fetchDadosRegistro(long dadosRegistroId) {
		return getService().fetchDadosRegistro(dadosRegistroId);
	}
	 ...
	 * @throws PortalException if a dados registro with the primary key could not be found
	 */
	public static DadosRegistro getDadosRegistro(long dadosRegistroId)
		throws PortalException {

		return getService().getDadosRegistro(dadosRegistroId);
	}

	public static DadosRegistro getDadosRegistroByGarantiaId(long garantiaId)
		throws br.com.seatecnologia.gdf.negocia.exception.
			NoSuchDadosRegistroException {

		return getService().getDadosRegistroByGarantiaId(garantiaId);
	}
	 ...
	 */
	public static List<DadosRegistro> getDadosRegistros(int start, int end) {
		return getService().getDadosRegistros(start, end);
	}
	 ...
	 */
	public static int getDadosRegistrosCount() {
		return getService().getDadosRegistrosCount();
	}
	 ...
	 */
	public static DadosRegistro updateDadosRegistro(
		DadosRegistro dadosRegistro) {

		return getService().updateDadosRegistro(dadosRegistro);
	}

	public static DadosRegistroLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<DadosRegistroLocalService> _serviceSnapshot =
		new Snapshot<>(
			DadosRegistroLocalServiceUtil.class,
			DadosRegistroLocalService.class);
