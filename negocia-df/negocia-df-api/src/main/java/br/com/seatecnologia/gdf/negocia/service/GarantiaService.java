...
/**
 * Provides the remote service interface for Garantia. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see GarantiaServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface GarantiaService extends BaseService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>br.com.seatecnologia.gdf.negocia.service.impl.GarantiaServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the garantia remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link GarantiaServiceUtil} if injection and service tracking are not available.
	 */
