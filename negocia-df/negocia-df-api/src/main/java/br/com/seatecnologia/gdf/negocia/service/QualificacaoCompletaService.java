...
/**
 * Provides the remote service interface for QualificacaoCompleta. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see QualificacaoCompletaServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface QualificacaoCompletaService extends BaseService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>br.com.seatecnologia.gdf.negocia.service.impl.QualificacaoCompletaServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the qualificacao completa remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link QualificacaoCompletaServiceUtil} if injection and service tracking are not available.
	 */
