...
/**
 * The persistence utility for the qualificacao contribuinte service. This utility wraps <code>br.com.seatecnologia.gdf.negocia.service.persistence.impl.QualificacaoContribuintePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see QualificacaoContribuintePersistence
 * @generated
 */
public class QualificacaoContribuinteUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(qualificacaoContribuinte);
	}
	 ...
	 */
	public static Map<Serializable, QualificacaoContribuinte>
	 ...
	 */
	public static List<QualificacaoContribuinte> findWithDynamicQuery(
	 ...
	 */
	public static QualificacaoContribuinte update(
		QualificacaoContribuinte qualificacaoContribuinte) {

		return getPersistence().update(qualificacaoContribuinte);
	}
	...
	public static QualificacaoContribuinte update(
		...
		return getPersistence().update(
			qualificacaoContribuinte, serviceContext);
	}
	 ...
	 */
	public static List<QualificacaoContribuinte> findByUuid(String uuid) {
	 ...
	 */
	public static List<QualificacaoContribuinte> findByUuid(
	 ...
	 */
	public static QualificacaoContribuinte findByUuid_First(
			String uuid,
			OrderByComparator<QualificacaoContribuinte> orderByComparator)
		throws br.com.seatecnologia.gdf.negocia.exception.
			NoSuchQualificacaoContribuinteException {
	 ...
	 */
	public static QualificacaoContribuinte fetchByUuid_First(
		String uuid,
		OrderByComparator<QualificacaoContribuinte> orderByComparator) {
	 ...
	 * @throws NoSuchQualificacaoContribuinteException if a matching qualificacao contribuinte could not be found
	 */
	public static QualificacaoContribuinte findByUuid_Last(
			String uuid,
			OrderByComparator<QualificacaoContribuinte> orderByComparator)
		throws br.com.seatecnologia.gdf.negocia.exception.
			NoSuchQualificacaoContribuinteException {
	 ...
	 */
	public static QualificacaoContribuinte fetchByUuid_Last(
		String uuid,
		OrderByComparator<QualificacaoContribuinte> orderByComparator) {
	 ...
	 */
	public static QualificacaoContribuinte[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			qualificacaoContribuinteId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchQualificacaoContribuinteException if a matching qualificacao contribuinte could not be found
	 */
	public static QualificacaoContribuinte findByUUID_G(
	 ...
	 */
	public static QualificacaoContribuinte fetchByUUID_G(
		String uuid, long groupId) {
	 ...
	 */
	public static QualificacaoContribuinte removeByUUID_G(
			String uuid, long groupId)
		throws br.com.seatecnologia.gdf.negocia.exception.
			NoSuchQualificacaoContribuinteException {
	 ...
	 * @return the matching qualificacao contribuintes
	 */
	public static List<QualificacaoContribuinte> findByUuid_C(
	 ...
	 * @throws NoSuchQualificacaoContribuinteException if a matching qualificacao contribuinte could not be found
	 */
	public static QualificacaoContribuinte findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<QualificacaoContribuinte> orderByComparator)
		throws br.com.seatecnologia.gdf.negocia.exception.
			NoSuchQualificacaoContribuinteException {
	 ...
	 * @return the first matching qualificacao contribuinte, or <code>null</code> if a matching qualificacao contribuinte could not be found
	 */
	public static QualificacaoContribuinte fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<QualificacaoContribuinte> orderByComparator) {
	 ...
	 * @throws NoSuchQualificacaoContribuinteException if a matching qualificacao contribuinte could not be found
	 */
	public static QualificacaoContribuinte findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<QualificacaoContribuinte> orderByComparator)
		throws br.com.seatecnologia.gdf.negocia.exception.
			NoSuchQualificacaoContribuinteException {
	 ...
	 * @return the last matching qualificacao contribuinte, or <code>null</code> if a matching qualificacao contribuinte could not be found
	 */
	public static QualificacaoContribuinte fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<QualificacaoContribuinte> orderByComparator) {
	 ...
	 * @throws NoSuchQualificacaoContribuinteException if a qualificacao contribuinte with the primary key could not be found
	 */
	public static QualificacaoContribuinte[] findByUuid_C_PrevAndNext(
		...
		return getPersistence().findByUuid_C_PrevAndNext(
			qualificacaoContribuinteId, uuid, companyId, orderByComparator);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(qualificacaoContribuinte);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(qualificacaoContribuintes);
	}
	 ...
	 */
	public static QualificacaoContribuinte create(
		long qualificacaoContribuinteId) {

		return getPersistence().create(qualificacaoContribuinteId);
	}
	 ...
	 * @throws NoSuchQualificacaoContribuinteException if a qualificacao contribuinte with the primary key could not be found
	 */
	public static QualificacaoContribuinte remove(
			long qualificacaoContribuinteId)
		throws br.com.seatecnologia.gdf.negocia.exception.
			NoSuchQualificacaoContribuinteException {

		return getPersistence().remove(qualificacaoContribuinteId);
	}

	public static QualificacaoContribuinte updateImpl(
		QualificacaoContribuinte qualificacaoContribuinte) {

		return getPersistence().updateImpl(qualificacaoContribuinte);
	}
	 ...
	 * @throws NoSuchQualificacaoContribuinteException if a qualificacao contribuinte with the primary key could not be found
	 */
	public static QualificacaoContribuinte findByPrimaryKey(
			long qualificacaoContribuinteId)
		throws br.com.seatecnologia.gdf.negocia.exception.
			NoSuchQualificacaoContribuinteException {

		return getPersistence().findByPrimaryKey(qualificacaoContribuinteId);
	}
	 ...
	 */
	public static QualificacaoContribuinte fetchByPrimaryKey(
		long qualificacaoContribuinteId) {

		return getPersistence().fetchByPrimaryKey(qualificacaoContribuinteId);
	}
	 ...
	 */
	public static List<QualificacaoContribuinte> findAll() {
	 ...
	 */
	public static List<QualificacaoContribuinte> findAll(int start, int end) {
	...
	public static QualificacaoContribuintePersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		QualificacaoContribuintePersistence persistence) {

		_persistence = persistence;
	}

	private static volatile QualificacaoContribuintePersistence _persistence;
