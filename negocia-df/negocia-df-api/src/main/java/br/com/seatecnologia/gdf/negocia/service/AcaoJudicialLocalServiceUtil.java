...
/**
 * Provides the local service utility for AcaoJudicial. This utility wraps
 * <code>br.com.seatecnologia.gdf.negocia.service.impl.AcaoJudicialLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AcaoJudicialLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>br.com.seatecnologia.gdf.negocia.service.impl.AcaoJudicialLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AcaoJudicial addAcaoJudicial(AcaoJudicial acaoJudicial) {
		return getService().addAcaoJudicial(acaoJudicial);
	}
	 ...
	 */
	public static AcaoJudicial createAcaoJudicial(long acaoId) {
		return getService().createAcaoJudicial(acaoId);
	}
	 ...
	 */
	public static AcaoJudicial deleteAcaoJudicial(AcaoJudicial acaoJudicial) {
		return getService().deleteAcaoJudicial(acaoJudicial);
	}
	 ...
	 */
	public static AcaoJudicial deleteAcaoJudicial(long acaoId)
		throws PortalException {

		return getService().deleteAcaoJudicial(acaoId);
	}
	...
	public static AcaoJudicial fetchAcaoJudicial(long acaoId) {
		return getService().fetchAcaoJudicial(acaoId);
	}
	 ...
	 * @throws PortalException if a acao judicial with the primary key could not be found
	 */
	public static AcaoJudicial getAcaoJudicial(long acaoId)
		throws PortalException {

		return getService().getAcaoJudicial(acaoId);
	}
	 ...
	 */
	public static int getAcaoJudicialsCount() {
		return getService().getAcaoJudicialsCount();
	}
	 ...
	 */
	public static AcaoJudicial updateAcaoJudicial(AcaoJudicial acaoJudicial) {
		return getService().updateAcaoJudicial(acaoJudicial);
	}
	...
	public static AcaoJudicialLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<AcaoJudicialLocalService> _serviceSnapshot =
		new Snapshot<>(
			AcaoJudicialLocalServiceUtil.class, AcaoJudicialLocalService.class);
