...
/**
 * Provides the local service interface for DocumentoComprobatorio. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DocumentoComprobatorioLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DocumentoComprobatorioLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>br.com.seatecnologia.gdf.negocia.service.impl.DocumentoComprobatorioLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the documento comprobatorio local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DocumentoComprobatorioLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DocumentoComprobatorio fetchDocumentoComprobatorio(long documentoId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DocumentoComprobatorio>
