...
/**
 * Provides the local service interface for Encargo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EncargoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EncargoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>br.com.seatecnologia.gdf.negocia.service.impl.EncargoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the encargo local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EncargoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Encargo addEncargo(Encargo encargo);

	public Encargo addEncargo(
	...
	public Encargo createEncargo(long encargoId);
	...
	public Encargo deleteEncargo(Encargo encargo);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Encargo deleteEncargo(long encargoId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Encargo fetchEncargo(long encargoId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Encargo getEncargo(long encargoId) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Encargo updateEncargo(Encargo encargo);

	public Encargo updateEncargo(
			long encargoId, long propostaId, double valorEncargos,
			String descricaoEncargos)
		throws PortalException;
