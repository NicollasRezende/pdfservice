...
/**
 * Provides the local service interface for IdentificacaoDebitos. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see IdentificacaoDebitosLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface IdentificacaoDebitosLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>br.com.seatecnologia.gdf.negocia.service.impl.IdentificacaoDebitosLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the identificacao debitos local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link IdentificacaoDebitosLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public IdentificacaoDebitos addIdentificacaoDebitos(
	...
	public IdentificacaoDebitos createIdentificacaoDebitos(
	...
	public IdentificacaoDebitos deleteIdentificacaoDebitos(
		IdentificacaoDebitos identificacaoDebitos);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public IdentificacaoDebitos fetchIdentificacaoDebitos(
		long identificacaoDebitosId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public IdentificacaoDebitos getIdentificacaoDebitos(
			long identificacaoDebitosId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<IdentificacaoDebitos> getIdentificacaoDebitosByFundamentacaoId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<IdentificacaoDebitos> getIdentificacaoDebitoses(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public IdentificacaoDebitos updateIdentificacaoDebitos(
		IdentificacaoDebitos identificacaoDebitos);
