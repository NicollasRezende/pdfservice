...
/**
 * Provides the local service utility for DemaisPartes. This utility wraps
 * <code>br.com.seatecnologia.gdf.negocia.service.impl.DemaisPartesLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DemaisPartesLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>br.com.seatecnologia.gdf.negocia.service.impl.DemaisPartesLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static DemaisPartes addDemaisPartes(DemaisPartes demaisPartes) {
		return getService().addDemaisPartes(demaisPartes);
	}
	 ...
	 */
	public static DemaisPartes createDemaisPartes(long demaisPartesId) {
		return getService().createDemaisPartes(demaisPartesId);
	}
	 ...
	 */
	public static DemaisPartes deleteDemaisPartes(DemaisPartes demaisPartes) {
		return getService().deleteDemaisPartes(demaisPartes);
	}
	 ...
	 */
	public static DemaisPartes deleteDemaisPartes(long demaisPartesId)
		throws PortalException {

		return getService().deleteDemaisPartes(demaisPartesId);
	}
	...
	public static DemaisPartes fetchDemaisPartes(long demaisPartesId) {
		return getService().fetchDemaisPartes(demaisPartesId);
	}
	 ...
	 * @throws PortalException if a demais partes with the primary key could not be found
	 */
	public static DemaisPartes getDemaisPartes(long demaisPartesId)
		throws PortalException {

		return getService().getDemaisPartes(demaisPartesId);
	}

	public static List<DemaisPartes> getDemaisPartesByPropostaId(
		long propostaId) {

		return getService().getDemaisPartesByPropostaId(propostaId);
	}
	 ...
	 */
	public static List<DemaisPartes> getDemaisParteses(int start, int end) {
		return getService().getDemaisParteses(start, end);
	}
	 ...
	 */
	public static int getDemaisPartesesCount() {
		return getService().getDemaisPartesesCount();
	}
	 ...
	 */
	public static DemaisPartes updateDemaisPartes(DemaisPartes demaisPartes) {
		return getService().updateDemaisPartes(demaisPartes);
	}

	public static DemaisPartesLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<DemaisPartesLocalService> _serviceSnapshot =
		new Snapshot<>(
			DemaisPartesLocalServiceUtil.class, DemaisPartesLocalService.class);
