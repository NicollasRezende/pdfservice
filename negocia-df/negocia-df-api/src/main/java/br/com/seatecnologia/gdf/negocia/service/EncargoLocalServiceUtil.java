...
/**
 * Provides the local service utility for Encargo. This utility wraps
 * <code>br.com.seatecnologia.gdf.negocia.service.impl.EncargoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class EncargoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>br.com.seatecnologia.gdf.negocia.service.impl.EncargoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Encargo addEncargo(Encargo encargo) {
		return getService().addEncargo(encargo);
	}
	 ...
	 */
	public static Encargo createEncargo(long encargoId) {
		return getService().createEncargo(encargoId);
	}
	 ...
	 */
	public static Encargo deleteEncargo(Encargo encargo) {
		return getService().deleteEncargo(encargo);
	}
	 ...
	 */
	public static Encargo deleteEncargo(long encargoId) throws PortalException {
		return getService().deleteEncargo(encargoId);
	}
	...
	public static Encargo fetchEncargo(long encargoId) {
		return getService().fetchEncargo(encargoId);
	}
	 ...
	 * @throws PortalException if a encargo with the primary key could not be found
	 */
	public static Encargo getEncargo(long encargoId) throws PortalException {
		return getService().getEncargo(encargoId);
	}
	 ...
	 */
	public static int getEncargosCount() {
		return getService().getEncargosCount();
	}
	 ...
	 */
	public static Encargo updateEncargo(Encargo encargo) {
		return getService().updateEncargo(encargo);
	}
	...
	public static EncargoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<EncargoLocalService> _serviceSnapshot =
		new Snapshot<>(
			EncargoLocalServiceUtil.class, EncargoLocalService.class);
