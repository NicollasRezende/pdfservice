...
/**
 * Provides the local service interface for Parcelamento. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ParcelamentoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ParcelamentoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>br.com.seatecnologia.gdf.negocia.service.impl.ParcelamentoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the parcelamento local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ParcelamentoLocalServiceUtil} if injection and service tracking are not available.
	 */
	public Parcelamento addParcelamento(
		long parcelamentoId, long propostaId, int numeroParcelas,
		double valorEntrada, Date dataPrimeiraParcela,
	...
	public Parcelamento updateParcelamento(
			long parcelamentoId, long propostaId, int numeroParcelas,
			double valorEntrada, Date dataPrimeiraParcela,
			double valorPrimeiraParcela)
		throws PortalException;
