...
/**
 * Provides the local service interface for DemonstracaoDocumentos. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DemonstracaoDocumentosLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DemonstracaoDocumentosLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>br.com.seatecnologia.gdf.negocia.service.impl.DemonstracaoDocumentosLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the demonstracao documentos local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DemonstracaoDocumentosLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public DemonstracaoDocumentos addDemonstracaoDocumentos(
	...
	public DemonstracaoDocumentos createDemonstracaoDocumentos(
	...
	public DemonstracaoDocumentos deleteDemonstracaoDocumentos(
		DemonstracaoDocumentos demonstracaoDocumentos);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DemonstracaoDocumentos fetchDemonstracaoDocumentos(
		long demonstracaoDocumentosId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DemonstracaoDocumentos getDemonstracaoDocumentos(
			long demonstracaoDocumentosId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DemonstracaoDocumentos> getDemonstracaoDocumentoses(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public DemonstracaoDocumentos updateDemonstracaoDocumentos(
		DemonstracaoDocumentos demonstracaoDocumentos);
