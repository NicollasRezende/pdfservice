...
public class PropostaPersistenceImpl
	 ...
	 */
	@Override
	public List<Proposta> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<Proposta> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	@Override
	public List<Proposta> findByUuid(
	...
	public List<Proposta> findByUuid(
		...
		List<Proposta> list = null;

		if (useFinderCache) {
			list = (List<Proposta>)finderCache.getResult(
				finderPath, finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (Proposta proposta : list) {
					if (!uuid.equals(proposta.getUuid())) {
						list = null;
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_PROPOSTA_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(PropostaModelImpl.ORDER_BY_JPQL);
			}
	...
	public Proposta findByUuid_First(
		...
		Proposta proposta = fetchByUuid_First(uuid, orderByComparator);
		...
		throw new NoSuchPropostaException(sb.toString());
	}
	...
	public Proposta fetchByUuid_First(
		...
		List<Proposta> list = findByUuid(uuid, 0, 1, orderByComparator);
	...
	public Proposta findByUuid_Last(
		...
		Proposta proposta = fetchByUuid_Last(uuid, orderByComparator);
	...
	public Proposta[] findByUuid_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(
				session, proposta, uuid, orderByComparator, true);

			array[1] = proposta;

			array[2] = getByUuid_PrevAndNext(
				session, proposta, uuid, orderByComparator, false);
	...
	protected Proposta getByUuid_PrevAndNext(
		Session session, Proposta proposta, String uuid,
		OrderByComparator<Proposta> orderByComparator, boolean previous) {
		...
		if (orderByComparator != null) {
			for (Object orderByConditionValue :
					orderByComparator.getOrderByConditionValues(proposta)) {

				queryPos.add(orderByConditionValue);
			}
		}

		List<Proposta> list = query.list();
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_PROPOSTA_WHERE);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(proposta.uuid IS NULL OR proposta.uuid = '')";
	...
	public Proposta findByUUID_G(String uuid, long groupId)
		...
		Proposta proposta = fetchByUUID_G(uuid, groupId);
	...
	public Proposta fetchByUUID_G(
		...
		if (result instanceof Proposta) {
			Proposta proposta = (Proposta)result;

			if (!Objects.equals(uuid, proposta.getUuid()) ||
	...
	public Proposta removeByUUID_G(String uuid, long groupId)
		...
		Proposta proposta = findByUUID_G(uuid, groupId);
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(proposta.uuid IS NULL OR proposta.uuid = '') AND ";
	 ...
	 */
	@Override
	public List<Proposta> findByUuid_C(String uuid, long companyId) {
		return findByUuid_C(
	 ...
	 */
	@Override
	public List<Proposta> findByUuid_C(
	...
	public List<Proposta> findByUuid_C(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Proposta proposta : list) {
					if (!uuid.equals(proposta.getUuid()) ||
						(companyId != proposta.getCompanyId())) {
	...
	public Proposta findByUuid_C_First(
		...
		Proposta proposta = fetchByUuid_C_First(
	...
	public Proposta fetchByUuid_C_First(
		...
		List<Proposta> list = findByUuid_C(
	...
	public Proposta findByUuid_C_Last(
		...
		Proposta proposta = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	public Proposta[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, proposta, uuid, companyId, orderByComparator, true);

			array[1] = proposta;

			array[2] = getByUuid_C_PrevAndNext(
				session, proposta, uuid, companyId, orderByComparator, false);
	...
	protected Proposta getByUuid_C_PrevAndNext(
		Session session, Proposta proposta, String uuid, long companyId,
		OrderByComparator<Proposta> orderByComparator, boolean previous) {
	...
	private FinderPath _finderPathWithPaginationFindByCpfCnpj;
	private FinderPath _finderPathWithoutPaginationFindByCpfCnpj;
	private FinderPath _finderPathCountByCpfCnpj;
	...
	public List<Proposta> findByCpfCnpj(String cpfCnpj) {
		return findByCpfCnpj(
			cpfCnpj, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<Proposta> findByCpfCnpj(String cpfCnpj, int start, int end) {
		return findByCpfCnpj(cpfCnpj, start, end, null);
	}
	 ...
	 */
	@Override
	public List<Proposta> findByCpfCnpj(
		String cpfCnpj, int start, int end,
		OrderByComparator<Proposta> orderByComparator) {

		return findByCpfCnpj(cpfCnpj, start, end, orderByComparator, true);
	}
	...
	public List<Proposta> findByCpfCnpj(
		...
		cpfCnpj = Objects.toString(cpfCnpj, "");
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByCpfCnpj;
				finderArgs = new Object[] {cpfCnpj};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByCpfCnpj;
			finderArgs = new Object[] {cpfCnpj, start, end, orderByComparator};
		}
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Proposta proposta : list) {
					if (!cpfCnpj.equals(proposta.getCpfCnpj())) {
						list = null;
		...
		if (list == null) {
			...
			if (cpfCnpj.isEmpty()) {
				sb.append(_FINDER_COLUMN_CPFCNPJ_CPFCNPJ_3);
			}
			else {
				bindCpfCnpj = true;

				sb.append(_FINDER_COLUMN_CPFCNPJ_CPFCNPJ_2);
			}
	...
	public Proposta findByCpfCnpj_First(
		...
		Proposta proposta = fetchByCpfCnpj_First(cpfCnpj, orderByComparator);
	...
	public Proposta fetchByCpfCnpj_First(
		...
		List<Proposta> list = findByCpfCnpj(cpfCnpj, 0, 1, orderByComparator);
	...
	public Proposta findByCpfCnpj_Last(
		...
		Proposta proposta = fetchByCpfCnpj_Last(cpfCnpj, orderByComparator);
	...
	public Proposta fetchByCpfCnpj_Last(
		...
		int count = countByCpfCnpj(cpfCnpj);

		if (count == 0) {
			return null;
		}

		List<Proposta> list = findByCpfCnpj(
			cpfCnpj, count - 1, count, orderByComparator);
	...
	public Proposta[] findByCpfCnpj_PrevAndNext(
		...
		try {
			...
			array[0] = getByCpfCnpj_PrevAndNext(
				session, proposta, cpfCnpj, orderByComparator, true);

			array[1] = proposta;

			array[2] = getByCpfCnpj_PrevAndNext(
				session, proposta, cpfCnpj, orderByComparator, false);
	...
	protected Proposta getByCpfCnpj_PrevAndNext(
		Session session, Proposta proposta, String cpfCnpj,
		OrderByComparator<Proposta> orderByComparator, boolean previous) {
	...
	public int countByCpfCnpj(String cpfCnpj) {
		...
		FinderPath finderPath = _finderPathCountByCpfCnpj;
	...
	private static final String _FINDER_COLUMN_CPFCNPJ_CPFCNPJ_2 =
		"proposta.cpfCnpj = ?";

	private static final String _FINDER_COLUMN_CPFCNPJ_CPFCNPJ_3 =
		"(proposta.cpfCnpj IS NULL OR proposta.cpfCnpj = '')";
	...
	public PropostaPersistenceImpl() {
		...
		setTable(PropostaTable.INSTANCE);
	}
	...
	public void cacheResult(Proposta proposta) {
		...
		finderCache.putResult(
			...
			new Object[] {proposta.getUuid(), proposta.getGroupId()}, proposta);
	}
	...
	public void cacheResult(List<Proposta> propostas) {
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (propostas.size() > _valueObjectFinderCacheListThreshold))) {
	...
	public void clearCache() {
		...
		finderCache.clearCache(PropostaImpl.class);
	}
	...
	public void clearCache(Proposta proposta) {
		entityCache.removeResult(PropostaImpl.class, proposta);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(PropostaImpl.class, primaryKey);
		}
	}

	protected void cacheUniqueFindersCache(
		PropostaModelImpl propostaModelImpl) {

		Object[] args = new Object[] {
			propostaModelImpl.getUuid(), propostaModelImpl.getGroupId()
		};

		finderCache.putResult(
			_finderPathFetchByUUID_G, args, propostaModelImpl);
	}
	...
	public Proposta create(long propostaId) {
		...
		proposta.setUuid(uuid);

		proposta.setCompanyId(CompanyThreadLocal.getCompanyId());
	...
	public Proposta remove(long propostaId) throws NoSuchPropostaException {
		return remove((Serializable)propostaId);
	}
	...
	public Proposta remove(Serializable primaryKey)
		...
		catch (NoSuchPropostaException noSuchEntityException) {
	...
	public Proposta updateImpl(Proposta proposta) {
		...
		if (!(proposta instanceof PropostaModelImpl)) {
			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(proposta.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(proposta);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in proposta proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom Proposta implementation " +
					proposta.getClass());
		}

		PropostaModelImpl propostaModelImpl = (PropostaModelImpl)proposta;

		if (Validator.isNull(proposta.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew && (proposta.getCreateDate() == null)) {
			if (serviceContext == null) {
				proposta.setCreateDate(date);
			}
			else {
				proposta.setCreateDate(serviceContext.getCreateDate(date));
			}
		}

		if (!propostaModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				proposta.setModifiedDate(date);
			}
			else {
				proposta.setModifiedDate(serviceContext.getModifiedDate(date));
			}
		}
		...
		entityCache.putResult(
			PropostaImpl.class, propostaModelImpl, false, true);

		cacheUniqueFindersCache(propostaModelImpl);
	...
	public Proposta findByPrimaryKey(long propostaId)
		...
		return findByPrimaryKey((Serializable)propostaId);
	}
	...
	public Proposta fetchByPrimaryKey(long propostaId) {
		return fetchByPrimaryKey((Serializable)propostaId);
	}
	...
	public List<Proposta> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_PROPOSTA);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_PROPOSTA);
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByCpfCnpj = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByCpfCnpj",
			new String[] {
				String.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"cpfCnpj"}, true);

		_finderPathWithoutPaginationFindByCpfCnpj = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByCpfCnpj",
			new String[] {String.class.getName()}, new String[] {"cpfCnpj"},
			true);

		_finderPathCountByCpfCnpj = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByCpfCnpj",
			new String[] {String.class.getName()}, new String[] {"cpfCnpj"},
			false);

		PropostaUtil.setPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		PropostaUtil.setPersistence(null);
	...
	private static final String _SQL_SELECT_PROPOSTA_WHERE =
		"SELECT proposta FROM Proposta proposta WHERE ";

	private static final String _SQL_COUNT_PROPOSTA =
		"SELECT COUNT(proposta) FROM Proposta proposta";

	private static final String _SQL_COUNT_PROPOSTA_WHERE =
		"SELECT COUNT(proposta) FROM Proposta proposta WHERE ";
	...
	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No Proposta exists with the key {";
