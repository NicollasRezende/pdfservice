...
/**
 * Provides the base implementation for the relacao credor remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.RelacaoCredorServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.RelacaoCredorServiceImpl
 * @generated
 */
public abstract class RelacaoCredorServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, RelacaoCredorService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RelacaoCredorService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.RelacaoCredorServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RelacaoCredorService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		relacaoCredorService = (RelacaoCredorService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return RelacaoCredorService.class.getName();
	}
	...
	@Reference
	protected br.com.seatecnologia.gdf.negocia.service.RelacaoCredorLocalService
		relacaoCredorLocalService;

	protected RelacaoCredorService relacaoCredorService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RelacaoCredorServiceBaseImpl.class);
