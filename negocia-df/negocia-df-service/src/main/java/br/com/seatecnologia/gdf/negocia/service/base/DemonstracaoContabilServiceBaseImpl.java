...
import br.com.seatecnologia.gdf.negocia.service.DemonstracaoContabilService;
...
/**
 * Provides the base implementation for the demonstracao contabil remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.DemonstracaoContabilServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.DemonstracaoContabilServiceImpl
 * @generated
 */
public abstract class DemonstracaoContabilServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DemonstracaoContabilService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DemonstracaoContabilService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.DemonstracaoContabilServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DemonstracaoContabilService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		demonstracaoContabilService = (DemonstracaoContabilService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DemonstracaoContabilService.class.getName();
	}
	...
	protected DemonstracaoContabilService demonstracaoContabilService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DemonstracaoContabilServiceBaseImpl.class);
