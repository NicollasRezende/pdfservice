...
/**
 * Provides the base implementation for the declaracao remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.DeclaracaoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.DeclaracaoServiceImpl
 * @generated
 */
public abstract class DeclaracaoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DeclaracaoService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DeclaracaoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.DeclaracaoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DeclaracaoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		declaracaoService = (DeclaracaoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DeclaracaoService.class.getName();
	}
	...
	@Reference
	protected br.com.seatecnologia.gdf.negocia.service.DeclaracaoLocalService
		declaracaoLocalService;

	protected DeclaracaoService declaracaoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DeclaracaoServiceBaseImpl.class);
