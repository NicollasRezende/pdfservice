...
import br.com.seatecnologia.gdf.negocia.service.QualificacaoContribuinteService;
...
/**
 * Provides the base implementation for the qualificacao contribuinte remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.QualificacaoContribuinteServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.QualificacaoContribuinteServiceImpl
 * @generated
 */
public abstract class QualificacaoContribuinteServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   QualificacaoContribuinteService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QualificacaoContribuinteService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.QualificacaoContribuinteServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QualificacaoContribuinteService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		qualificacaoContribuinteService =
			(QualificacaoContribuinteService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QualificacaoContribuinteService.class.getName();
	}
	...
	@Reference
	protected br.com.seatecnologia.gdf.negocia.service.
		QualificacaoContribuinteLocalService
			qualificacaoContribuinteLocalService;

	protected QualificacaoContribuinteService qualificacaoContribuinteService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		QualificacaoContribuinteServiceBaseImpl.class);
