 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.EnderecoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.EnderecoLocalServiceImpl
 * @generated
 */
public abstract class EnderecoLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EnderecoLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EnderecoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.EnderecoLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return enderecoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Endereco.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return enderecoPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return enderecoPersistence.countWithDynamicQuery(
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(enderecoLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Endereco.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("enderecoId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Endereco.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("enderecoId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return enderecoPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement EnderecoLocalServiceImpl#deleteEndereco(Endereco) to avoid orphaned data");
		}

		return enderecoLocalService.deleteEndereco((Endereco)persistedModel);
	}

	@Override
	public BasePersistence<Endereco> getBasePersistence() {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EnderecoLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		enderecoLocalService = (EnderecoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EnderecoLocalService.class.getName();
	}
	...
	protected EnderecoLocalService enderecoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EnderecoLocalServiceBaseImpl.class);
