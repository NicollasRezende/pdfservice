...
import br.com.seatecnologia.gdf.negocia.service.TermoAssinadoService;
...
/**
 * Provides the base implementation for the termo assinado remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.TermoAssinadoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.TermoAssinadoServiceImpl
 * @generated
 */
public abstract class TermoAssinadoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, TermoAssinadoService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TermoAssinadoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.TermoAssinadoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TermoAssinadoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		termoAssinadoService = (TermoAssinadoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TermoAssinadoService.class.getName();
	}
	...
	@Reference
	protected br.com.seatecnologia.gdf.negocia.service.TermoAssinadoLocalService
		termoAssinadoLocalService;

	protected TermoAssinadoService termoAssinadoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TermoAssinadoServiceBaseImpl.class);
