...
import br.com.seatecnologia.gdf.negocia.service.ProcuracaoService;
...
/**
 * Provides the base implementation for the procuracao remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.ProcuracaoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.ProcuracaoServiceImpl
 * @generated
 */
public abstract class ProcuracaoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, ProcuracaoService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProcuracaoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.ProcuracaoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProcuracaoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		procuracaoService = (ProcuracaoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProcuracaoService.class.getName();
	}
	...
	@Reference
	protected br.com.seatecnologia.gdf.negocia.service.ProcuracaoLocalService
		procuracaoLocalService;

	protected ProcuracaoService procuracaoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProcuracaoServiceBaseImpl.class);
