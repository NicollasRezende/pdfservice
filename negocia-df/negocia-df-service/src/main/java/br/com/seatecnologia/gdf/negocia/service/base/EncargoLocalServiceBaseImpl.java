...
import br.com.seatecnologia.gdf.negocia.service.EncargoLocalService;
...
/**
 * Provides the base implementation for the encargo local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.EncargoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.EncargoLocalServiceImpl
 * @generated
 */
public abstract class EncargoLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EncargoLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EncargoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.EncargoLocalServiceUtil</code>.
	 */
	...
	public Encargo createEncargo(long encargoId) {
		return encargoPersistence.create(encargoId);
	}
	...
	public Encargo deleteEncargo(long encargoId) throws PortalException {
		return encargoPersistence.remove(encargoId);
	}
	...
	public Encargo deleteEncargo(Encargo encargo) {
		return encargoPersistence.remove(encargo);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return encargoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Encargo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return encargoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return encargoPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return encargoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return encargoPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Encargo fetchEncargo(long encargoId) {
		return encargoPersistence.fetchByPrimaryKey(encargoId);
	}
	...
	public Encargo getEncargo(long encargoId) throws PortalException {
		return encargoPersistence.findByPrimaryKey(encargoId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(encargoLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Encargo.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("encargoId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Encargo.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("encargoId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return encargoPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement EncargoLocalServiceImpl#deleteEncargo(Encargo) to avoid orphaned data");
		}

		return encargoLocalService.deleteEncargo((Encargo)persistedModel);
	}

	@Override
	public BasePersistence<Encargo> getBasePersistence() {
		return encargoPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return encargoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Encargo> getEncargos(int start, int end) {
		return encargoPersistence.findAll(start, end);
	}
	...
	public int getEncargosCount() {
		return encargoPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EncargoLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		encargoLocalService = (EncargoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EncargoLocalService.class.getName();
	}
	...
	protected EncargoLocalService encargoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EncargoLocalServiceBaseImpl.class);
