...
/**
 * Provides the base implementation for the identificacao debitos remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.IdentificacaoDebitosServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.IdentificacaoDebitosServiceImpl
 * @generated
 */
public abstract class IdentificacaoDebitosServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   IdentificacaoDebitosService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>IdentificacaoDebitosService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.IdentificacaoDebitosServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			IdentificacaoDebitosService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		identificacaoDebitosService = (IdentificacaoDebitosService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return IdentificacaoDebitosService.class.getName();
	}
	...
	protected IdentificacaoDebitosService identificacaoDebitosService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		IdentificacaoDebitosServiceBaseImpl.class);
