...
import br.com.seatecnologia.gdf.negocia.service.BemDireitoAdicionalService;
...
/**
 * Provides the base implementation for the bem direito adicional remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.BemDireitoAdicionalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.BemDireitoAdicionalServiceImpl
 * @generated
 */
public abstract class BemDireitoAdicionalServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, BemDireitoAdicionalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BemDireitoAdicionalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.BemDireitoAdicionalServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BemDireitoAdicionalService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		bemDireitoAdicionalService = (BemDireitoAdicionalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return BemDireitoAdicionalService.class.getName();
	}
	...
	@Reference
	protected
		br.com.seatecnologia.gdf.negocia.service.BemDireitoAdicionalLocalService
			bemDireitoAdicionalLocalService;

	protected BemDireitoAdicionalService bemDireitoAdicionalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BemDireitoAdicionalServiceBaseImpl.class);
