...
/**
 * Provides the base implementation for the garantia proposta remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.GarantiaPropostaServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.GarantiaPropostaServiceImpl
 * @generated
 */
public abstract class GarantiaPropostaServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, GarantiaPropostaService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>GarantiaPropostaService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.GarantiaPropostaServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			GarantiaPropostaService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		garantiaPropostaService = (GarantiaPropostaService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return GarantiaPropostaService.class.getName();
	}
	...
	@Reference
	protected
		br.com.seatecnologia.gdf.negocia.service.GarantiaPropostaLocalService
			garantiaPropostaLocalService;

	protected GarantiaPropostaService garantiaPropostaService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		GarantiaPropostaServiceBaseImpl.class);
