...
/**
 * Provides the base implementation for the acao judicial remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.AcaoJudicialServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.AcaoJudicialServiceImpl
 * @generated
 */
public abstract class AcaoJudicialServiceBaseImpl
	extends BaseServiceImpl
	implements AcaoJudicialService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AcaoJudicialService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.AcaoJudicialServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AcaoJudicialService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		acaoJudicialService = (AcaoJudicialService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AcaoJudicialService.class.getName();
	}
	...
	@Reference
	protected br.com.seatecnologia.gdf.negocia.service.AcaoJudicialLocalService
		acaoJudicialLocalService;

	protected AcaoJudicialService acaoJudicialService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AcaoJudicialServiceBaseImpl.class);
