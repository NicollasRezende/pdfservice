...
/**
 * Provides the base implementation for the fundamentacao pedido remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.FundamentacaoPedidoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.FundamentacaoPedidoServiceImpl
 * @generated
 */
public abstract class FundamentacaoPedidoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FundamentacaoPedidoService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FundamentacaoPedidoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.FundamentacaoPedidoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FundamentacaoPedidoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		fundamentacaoPedidoService = (FundamentacaoPedidoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FundamentacaoPedidoService.class.getName();
	}
	...
	@Reference
	protected
		br.com.seatecnologia.gdf.negocia.service.FundamentacaoPedidoLocalService
			fundamentacaoPedidoLocalService;

	protected FundamentacaoPedidoService fundamentacaoPedidoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FundamentacaoPedidoServiceBaseImpl.class);
