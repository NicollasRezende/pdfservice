...
/**
 * Provides the base implementation for the dados registro remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.DadosRegistroServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.DadosRegistroServiceImpl
 * @generated
 */
public abstract class DadosRegistroServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DadosRegistroService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DadosRegistroService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.DadosRegistroServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DadosRegistroService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dadosRegistroService = (DadosRegistroService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DadosRegistroService.class.getName();
	}
	...
	@Reference
	protected br.com.seatecnologia.gdf.negocia.service.DadosRegistroLocalService
		dadosRegistroLocalService;

	protected DadosRegistroService dadosRegistroService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DadosRegistroServiceBaseImpl.class);
