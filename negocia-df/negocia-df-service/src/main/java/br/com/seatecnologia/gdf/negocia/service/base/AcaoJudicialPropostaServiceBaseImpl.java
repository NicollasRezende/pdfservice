...
import br.com.seatecnologia.gdf.negocia.service.AcaoJudicialPropostaService;
...
/**
 * Provides the base implementation for the acao judicial proposta remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.AcaoJudicialPropostaServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.AcaoJudicialPropostaServiceImpl
 * @generated
 */
public abstract class AcaoJudicialPropostaServiceBaseImpl
	extends BaseServiceImpl
	implements AcaoJudicialPropostaService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AcaoJudicialPropostaService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.AcaoJudicialPropostaServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AcaoJudicialPropostaService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		acaoJudicialPropostaService = (AcaoJudicialPropostaService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AcaoJudicialPropostaService.class.getName();
	}
	...
	protected AcaoJudicialPropostaService acaoJudicialPropostaService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AcaoJudicialPropostaServiceBaseImpl.class);
