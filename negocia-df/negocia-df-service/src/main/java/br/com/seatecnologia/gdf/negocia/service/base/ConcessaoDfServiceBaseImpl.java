...
import br.com.seatecnologia.gdf.negocia.service.ConcessaoDfService;
...
/**
 * Provides the base implementation for the concessao df remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.ConcessaoDfServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.ConcessaoDfServiceImpl
 * @generated
 */
public abstract class ConcessaoDfServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, ConcessaoDfService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ConcessaoDfService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.ConcessaoDfServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ConcessaoDfService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		concessaoDfService = (ConcessaoDfService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ConcessaoDfService.class.getName();
	}
	...
	@Reference
	protected br.com.seatecnologia.gdf.negocia.service.ConcessaoDfLocalService
		concessaoDfLocalService;

	protected ConcessaoDfService concessaoDfService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ConcessaoDfServiceBaseImpl.class);
