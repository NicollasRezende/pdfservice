...
import br.com.seatecnologia.gdf.negocia.service.EditalService;
...
/**
 * Provides the base implementation for the edital remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.EditalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.EditalServiceImpl
 * @generated
 */
public abstract class EditalServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EditalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EditalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.EditalServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EditalService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		editalService = (EditalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EditalService.class.getName();
	}
	...
	@Reference
	protected br.com.seatecnologia.gdf.negocia.service.EditalLocalService
		editalLocalService;
