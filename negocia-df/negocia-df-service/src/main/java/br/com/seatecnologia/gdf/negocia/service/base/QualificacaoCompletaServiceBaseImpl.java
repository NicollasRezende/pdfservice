...
/**
 * Provides the base implementation for the qualificacao completa remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.QualificacaoCompletaServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.QualificacaoCompletaServiceImpl
 * @generated
 */
public abstract class QualificacaoCompletaServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   QualificacaoCompletaService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QualificacaoCompletaService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.QualificacaoCompletaServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QualificacaoCompletaService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		qualificacaoCompletaService = (QualificacaoCompletaService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QualificacaoCompletaService.class.getName();
	}
	...
	protected QualificacaoCompletaService qualificacaoCompletaService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		QualificacaoCompletaServiceBaseImpl.class);
