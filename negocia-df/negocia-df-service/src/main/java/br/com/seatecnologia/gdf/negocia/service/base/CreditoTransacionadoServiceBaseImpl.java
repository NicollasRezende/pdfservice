...
import br.com.seatecnologia.gdf.negocia.service.CreditoTransacionadoService;
...
/**
 * Provides the base implementation for the credito transacionado remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.CreditoTransacionadoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.CreditoTransacionadoServiceImpl
 * @generated
 */
public abstract class CreditoTransacionadoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CreditoTransacionadoService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CreditoTransacionadoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.CreditoTransacionadoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CreditoTransacionadoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		creditoTransacionadoService = (CreditoTransacionadoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CreditoTransacionadoService.class.getName();
	}
	...
	protected CreditoTransacionadoService creditoTransacionadoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CreditoTransacionadoServiceBaseImpl.class);
