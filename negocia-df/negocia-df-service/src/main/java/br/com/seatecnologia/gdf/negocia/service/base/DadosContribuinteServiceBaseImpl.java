...
/**
 * Provides the base implementation for the dados contribuinte remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.DadosContribuinteServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.DadosContribuinteServiceImpl
 * @generated
 */
public abstract class DadosContribuinteServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DadosContribuinteService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DadosContribuinteService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.DadosContribuinteServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DadosContribuinteService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dadosContribuinteService = (DadosContribuinteService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DadosContribuinteService.class.getName();
	}
	...
	@Reference
	protected
		br.com.seatecnologia.gdf.negocia.service.DadosContribuinteLocalService
			dadosContribuinteLocalService;

	protected DadosContribuinteService dadosContribuinteService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DadosContribuinteServiceBaseImpl.class);
