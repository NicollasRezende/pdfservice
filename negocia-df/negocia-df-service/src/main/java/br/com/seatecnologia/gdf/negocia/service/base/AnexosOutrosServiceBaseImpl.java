...
/**
 * Provides the base implementation for the anexos outros remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.AnexosOutrosServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.AnexosOutrosServiceImpl
 * @generated
 */
public abstract class AnexosOutrosServiceBaseImpl
	extends BaseServiceImpl
	implements AnexosOutrosService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AnexosOutrosService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.AnexosOutrosServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AnexosOutrosService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		anexosOutrosService = (AnexosOutrosService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AnexosOutrosService.class.getName();
	}
	...
	@Reference
	protected br.com.seatecnologia.gdf.negocia.service.AnexosOutrosLocalService
		anexosOutrosLocalService;

	protected AnexosOutrosService anexosOutrosService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AnexosOutrosServiceBaseImpl.class);
