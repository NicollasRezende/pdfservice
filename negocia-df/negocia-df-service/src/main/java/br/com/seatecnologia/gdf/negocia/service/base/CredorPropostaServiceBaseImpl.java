...
import br.com.seatecnologia.gdf.negocia.service.CredorPropostaService;
...
/**
 * Provides the base implementation for the credor proposta remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.CredorPropostaServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.CredorPropostaServiceImpl
 * @generated
 */
public abstract class CredorPropostaServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CredorPropostaService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CredorPropostaService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.CredorPropostaServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CredorPropostaService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		credorPropostaService = (CredorPropostaService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CredorPropostaService.class.getName();
	}
	...
	@Reference
	protected
		br.com.seatecnologia.gdf.negocia.service.CredorPropostaLocalService
			credorPropostaLocalService;

	protected CredorPropostaService credorPropostaService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CredorPropostaServiceBaseImpl.class);
