...
/**
 * Provides the base implementation for the administrador judicial remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.AdministradorJudicialServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.AdministradorJudicialServiceImpl
 * @generated
 */
public abstract class AdministradorJudicialServiceBaseImpl
	extends BaseServiceImpl
	implements AdministradorJudicialService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AdministradorJudicialService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.AdministradorJudicialServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AdministradorJudicialService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		administradorJudicialService = (AdministradorJudicialService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AdministradorJudicialService.class.getName();
	}
	...
	protected AdministradorJudicialService administradorJudicialService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AdministradorJudicialServiceBaseImpl.class);
