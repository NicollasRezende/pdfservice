...
/**
 * Provides the base implementation for the proposta remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.PropostaServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.PropostaServiceImpl
 * @generated
 */
public abstract class PropostaServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PropostaService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PropostaService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.PropostaServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PropostaService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		propostaService = (PropostaService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PropostaService.class.getName();
	}
	...
	@Reference
	protected br.com.seatecnologia.gdf.negocia.service.PropostaLocalService
