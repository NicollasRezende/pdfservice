...
import br.com.seatecnologia.gdf.negocia.service.ComprovanteHonorarioService;
...
/**
 * Provides the base implementation for the comprovante honorario remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.ComprovanteHonorarioServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.ComprovanteHonorarioServiceImpl
 * @generated
 */
public abstract class ComprovanteHonorarioServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, ComprovanteHonorarioService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ComprovanteHonorarioService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.ComprovanteHonorarioServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ComprovanteHonorarioService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		comprovanteHonorarioService = (ComprovanteHonorarioService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ComprovanteHonorarioService.class.getName();
	}
	...
	protected ComprovanteHonorarioService comprovanteHonorarioService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ComprovanteHonorarioServiceBaseImpl.class);
