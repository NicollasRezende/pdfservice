 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.EnderecoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.EnderecoServiceImpl
 * @generated
 */
public abstract class EnderecoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EnderecoService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EnderecoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.EnderecoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EnderecoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		enderecoService = (EnderecoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EnderecoService.class.getName();
	}
	...
	@Reference
	protected br.com.seatecnologia.gdf.negocia.service.EnderecoLocalService
