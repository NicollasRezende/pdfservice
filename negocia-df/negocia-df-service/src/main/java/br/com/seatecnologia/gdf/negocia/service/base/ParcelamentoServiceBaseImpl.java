...
import br.com.seatecnologia.gdf.negocia.service.ParcelamentoService;
...
/**
 * Provides the base implementation for the parcelamento remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.ParcelamentoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.ParcelamentoServiceImpl
 * @generated
 */
public abstract class ParcelamentoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, ParcelamentoService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ParcelamentoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.ParcelamentoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ParcelamentoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		parcelamentoService = (ParcelamentoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ParcelamentoService.class.getName();
	}
	...
	@Reference
	protected br.com.seatecnologia.gdf.negocia.service.ParcelamentoLocalService
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ParcelamentoServiceBaseImpl.class);
