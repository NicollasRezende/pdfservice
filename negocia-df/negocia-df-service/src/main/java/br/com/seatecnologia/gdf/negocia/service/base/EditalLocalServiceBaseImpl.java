...
/**
 * Provides the base implementation for the edital local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.EditalLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.EditalLocalServiceImpl
 * @generated
 */
public abstract class EditalLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EditalLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EditalLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.EditalLocalServiceUtil</code>.
	 */
	...
	public Edital addEdital(Edital edital) {
		...
		return editalPersistence.update(edital);
	}
	...
	public Edital createEdital(long editalId) {
		return editalPersistence.create(editalId);
	}
	...
	public Edital deleteEdital(long editalId) throws PortalException {
		return editalPersistence.remove(editalId);
	}
	...
	public Edital deleteEdital(Edital edital) {
		return editalPersistence.remove(edital);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return editalPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Edital.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return editalPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return editalPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return editalPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return editalPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return editalPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Edital fetchEdital(long editalId) {
		return editalPersistence.fetchByPrimaryKey(editalId);
	}
	...
	public Edital getEdital(long editalId) throws PortalException {
		return editalPersistence.findByPrimaryKey(editalId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(editalLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Edital.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("editalId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(editalLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Edital.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("editalId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return editalPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement EditalLocalServiceImpl#deleteEdital(Edital) to avoid orphaned data");
		}

		return editalLocalService.deleteEdital((Edital)persistedModel);
	}

	@Override
	public BasePersistence<Edital> getBasePersistence() {
		return editalPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return editalPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Edital> getEditals(int start, int end) {
		return editalPersistence.findAll(start, end);
	}
	...
	public int getEditalsCount() {
		return editalPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EditalLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		editalLocalService = (EditalLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EditalLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		DataSource dataSource = editalPersistence.getDataSource();
	...
	protected EditalLocalService editalLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EditalLocalServiceBaseImpl.class);
