...
/**
 * Provides the base implementation for the documento comprobatorio remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.DocumentoComprobatorioServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.DocumentoComprobatorioServiceImpl
 * @generated
 */
public abstract class DocumentoComprobatorioServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DocumentoComprobatorioService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DocumentoComprobatorioService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.DocumentoComprobatorioServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DocumentoComprobatorioService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		documentoComprobatorioService = (DocumentoComprobatorioService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DocumentoComprobatorioService.class.getName();
	}
	...
	protected DocumentoComprobatorioService documentoComprobatorioService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DocumentoComprobatorioServiceBaseImpl.class);
