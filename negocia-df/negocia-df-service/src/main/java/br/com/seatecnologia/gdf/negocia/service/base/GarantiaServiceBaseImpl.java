...
/**
 * Provides the base implementation for the garantia remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.GarantiaServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.GarantiaServiceImpl
 * @generated
 */
public abstract class GarantiaServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, GarantiaService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>GarantiaService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.GarantiaServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			GarantiaService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		garantiaService = (GarantiaService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return GarantiaService.class.getName();
	}
	...
	@Reference
	protected br.com.seatecnologia.gdf.negocia.service.GarantiaLocalService
