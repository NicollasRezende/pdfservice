...
/**
 * Provides the base implementation for the bens direitos laudo remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.BensDireitosLaudoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.BensDireitosLaudoServiceImpl
 * @generated
 */
public abstract class BensDireitosLaudoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, BensDireitosLaudoService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BensDireitosLaudoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.BensDireitosLaudoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BensDireitosLaudoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		bensDireitosLaudoService = (BensDireitosLaudoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return BensDireitosLaudoService.class.getName();
	}
	...
	@Reference
	protected
		br.com.seatecnologia.gdf.negocia.service.BensDireitosLaudoLocalService
			bensDireitosLaudoLocalService;

	protected BensDireitosLaudoService bensDireitosLaudoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BensDireitosLaudoServiceBaseImpl.class);
