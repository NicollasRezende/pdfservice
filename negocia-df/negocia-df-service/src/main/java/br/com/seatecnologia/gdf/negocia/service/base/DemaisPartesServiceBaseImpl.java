...
/**
 * Provides the base implementation for the demais partes remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.gdf.negocia.service.impl.DemaisPartesServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see br.com.seatecnologia.gdf.negocia.service.impl.DemaisPartesServiceImpl
 * @generated
 */
public abstract class DemaisPartesServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DemaisPartesService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DemaisPartesService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>br.com.seatecnologia.gdf.negocia.service.DemaisPartesServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DemaisPartesService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		demaisPartesService = (DemaisPartesService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DemaisPartesService.class.getName();
	}
	...
	@Reference
	protected br.com.seatecnologia.gdf.negocia.service.DemaisPartesLocalService
		demaisPartesLocalService;

	protected DemaisPartesService demaisPartesService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DemaisPartesServiceBaseImpl.class);
