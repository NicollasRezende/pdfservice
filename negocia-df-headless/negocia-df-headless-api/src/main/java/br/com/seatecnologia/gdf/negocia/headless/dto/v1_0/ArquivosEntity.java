 ...
 */
@Generated("")
@GraphQLName("ArquivosEntity")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ArquivosEntity")
public class ArquivosEntity implements Serializable {

	public static ArquivosEntity toDTO(String json) {
		return ObjectMapperUtil.readValue(ArquivosEntity.class, json);
	}

	public static ArquivosEntity unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(ArquivosEntity.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "br.com.seatecnologia.gdf.negocia.headless.dto.v1_0.ArquivosEntity",
		name = "x-class-name"
	)
