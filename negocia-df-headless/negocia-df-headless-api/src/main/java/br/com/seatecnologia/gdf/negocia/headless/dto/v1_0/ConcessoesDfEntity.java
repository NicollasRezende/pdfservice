 ...
 */
@Generated("")
@GraphQLName("ConcessoesDfEntity")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ConcessoesDfEntity")
public class ConcessoesDfEntity implements Serializable {

	public static ConcessoesDfEntity toDTO(String json) {
		return ObjectMapperUtil.readValue(ConcessoesDfEntity.class, json);
	}

	public static ConcessoesDfEntity unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(ConcessoesDfEntity.class, json);
	}

	@io.swagger.v3.oas.annotations.media.Schema
	public Long getConcessaoId() {
		if (_concessaoIdSupplier != null) {
			concessaoId = _concessaoIdSupplier.get();

			_concessaoIdSupplier = null;
		}
	...
	public void setConcessaoId(
		...
		_concessaoIdSupplier = () -> {
			try {
				return concessaoIdUnsafeSupplier.get();
			}
	...
	@JsonIgnore
	private Supplier<Long> _concessaoIdSupplier;
	...
	public String toString() {
		...
		Long concessaoId = getConcessaoId();
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "br.com.seatecnologia.gdf.negocia.headless.dto.v1_0.ConcessoesDfEntity",
		name = "x-class-name"
	)
