package br.com.seatecnologia.gdf.negocia.headless.internal.graphql.mutation.v1_0;
...
public class Mutation {
	...
	@GraphQLField
	public PropostaEntity createProposta(
			@GraphQLName("propostaEntity") PropostaEntity propostaEntity)
		throws Exception {

		return _applyComponentServiceObjects(
			_propostaEntityResourceComponentServiceObjects,
			this::_populateResourceContext,
			propostaEntityResource -> propostaEntityResource.postProposta(
				propostaEntity));
	}
