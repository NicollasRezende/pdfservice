...
public abstract class BaseEditalEntityResourceImpl
	implements EditalEntityResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/negocia-df-headless/v1.0/metadados'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "EditalEntity")}
	)
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/metadados")
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseEditalEntityResourceImpl.class);
