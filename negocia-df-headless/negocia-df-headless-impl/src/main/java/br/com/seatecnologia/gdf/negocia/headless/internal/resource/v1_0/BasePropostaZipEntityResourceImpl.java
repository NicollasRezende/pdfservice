...
public abstract class BasePropostaZipEntityResourceImpl
	implements PropostaZipEntityResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/negocia-df-headless/v1.0/propostas/zip/{propostaId}'  -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(name = "PropostaZipEntity")
		}
	)
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/propostas/zip/{propostaId}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public PropostaZipEntity getPropostaZip(
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BasePropostaZipEntityResourceImpl.class);
