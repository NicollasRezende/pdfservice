...
public abstract class BaseUsuarioInfoResourceImpl
	implements UsuarioInfoResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/negocia-df-headless/v1.0/usuario-info'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "UsuarioInfo")}
	)
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/usuario-info")
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseUsuarioInfoResourceImpl.class);
