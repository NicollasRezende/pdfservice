...
/**
 * The base model interface for the ArticleEditLock service. Represents a row in the &quot;ArticleLock_ArticleEditLock&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.example.article.lock.model.impl.ArticleEditLockModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.example.article.lock.model.impl.ArticleEditLockImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface ArticleEditLockModel
	extends BaseModel<ArticleEditLock>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a article edit lock model instance should use the {@link ArticleEditLock} interface instead.
	 */
